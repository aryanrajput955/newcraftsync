			...
			<section className='relative w-full h-screen flex items-center justify-center overflow-hidden'>
				<div className='relative z-10 max-w-7xl mx-auto px-6 lg:px-8 text-center'>
					...
					<h1 className='text-5xl md:text-7xl font-bold text-navy-900 mb-6 tracking-tight animate-fade-in-up delay-100'>
						We Craft{' '}
						<span className='text-transparent bg-clip-text bg-gradient-to-r from-slate-600 to-navy-800'>
							Digital
						</span>{' '}
						<br />
					...
					<p className='max-w-2xl mx-auto text-lg md:text-xl text-slate-600 mb-10 leading-relaxed animate-fade-in-up delay-200'>
						We are a team of visionary creators, strategists, and developers
						dedicated to transforming brands through innovative digital
						solutions.
					</p>
